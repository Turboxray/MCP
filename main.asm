...
.tbl																																									;
	...
	.dw .b0, .b1, .b2, .b3, .b4, .b5, .b6, .b7, .b8, .b9, .ba, .bb											;
;//....................................................................................
...
DDA3:
			.db Prefix2., DirVolSet.,$20, DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$40, DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$60, DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$80, DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$A0, DDA., C.
			.db Prefix2., DirVolSet.,$60, DDA., E.
			.db Prefix2., DirVolSet.,$50, DDA., E.
			.db Prefix2., DirVolSet.,$40, DDA., E.
			.db Rest.
			.db Prefix2., DirVolSet.,$00, DDA., D.
			.db DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$40, DDA., C.
			.db Rest.
			.db Prefix2., DirVolSet.,$60, DDA., D.
			.db Prefix2., DirVolSet.,$00, DDA., D.
			.db Prefix2., DirVolSet.,$40, DDA., D.
			.db Prefix2., DirVolSet.,$00, DDA., E.
			.db Prefix2., DirVolSet.,$00, DDA., C.
			.db Prefix2., DirVolSet.,$60, DDA., D.
			.db Prefix2., DirVolSet.,$00, DDA., E.
			.db Prefix2., DirVolSet.,$40, DDA., D.
			.db Prefix2., DirVolSet.,$00, DDA., E.
